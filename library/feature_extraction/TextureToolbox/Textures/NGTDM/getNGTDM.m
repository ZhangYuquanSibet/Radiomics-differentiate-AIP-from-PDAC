...
if twoD
    ...
    w8 = 1; w4 = 1; % Weights given to different neighbors to correct for discretization length differences
    ...
    posValid = [i,j,k];
    nValid_temp = size(posValid,1);
    w26 = 1; w18 = 1; w6=1; % Weights given to different neighbors to correct for discretization length differences
